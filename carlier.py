class RPQ:
   ...
   # def carlier(self, data):
    ...
    @staticmethod
    def schrage_pmtn(N):
        #N = RPQ.readData(data)  # wczytuje dane z pliku
        #k = 1
        G = []
        sorted = RPQ.sort_R(N)
        min_r = sorted[0][0]
...
wyniki_schrage.append(RPQ.loss_function(RPQ.schrage(RPQ.readData('data10.txt'))).pop())
wyniki_schrage.append(RPQ.loss_function(RPQ.schrage(RPQ.readData('data20.txt'))).pop())
wyniki_schrage.append(RPQ.loss_function(RPQ.schrage(RPQ.readData('data50.txt'))).pop())
wyniki_schrage.append(RPQ.loss_function(RPQ.schrage(RPQ.readData('data100.txt'))).pop())
wyniki_schrage.append(RPQ.loss_function(RPQ.schrage(RPQ.readData('data500.txt'))).pop())
print(wyniki_schrage)
wyniki_schrage_pmtn.append(RPQ.schrage_pmtn(RPQ.readData('data10.txt')))
wyniki_schrage_pmtn.append(RPQ.schrage_pmtn(RPQ.readData('data20.txt')))
wyniki_schrage_pmtn.append(RPQ.schrage_pmtn(RPQ.readData('data50.txt')))
wyniki_schrage_pmtn.append(RPQ.schrage_pmtn(RPQ.readData('data100.txt')))
wyniki_schrage_pmtn.append(RPQ.schrage_pmtn(RPQ.readData('data500.txt')))
